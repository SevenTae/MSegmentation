...
class Model_test(object):
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 6:
            ...
            #                 (128, 64, 12)]
            self.colors = [(255, 0, 0), (255, 255, 0), (192, 192, 0), (0, 255, 0),
                           (128, 128, 128), (0, 0, 255)]
        else:
    ...
    def generate(self, onnx=False):
        self.net = UNet(n_channels=3,n_classes=6)
    ...
    def detect_image(self, image, count=False, name_classes=None):
        ...
        #   直接resize进行识别
        #---------------------------------------------------------#
        image_data = resize_imagenormal(image, (self.input_shape[1],self.input_shape[0]))
        #---------------------------------------------------------#
        #   添加上batch_size维度
        #---------------------------------------------------------#
